<!-- Modal -->
<form action="{{URL::route('journals.store')}}" method="post">
    @csrf
    <!-- {{ csrf_field() }} -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="parent_id" value="{{$currentJournal->id}}">
                    <div class="mb-3">
                        <label>Оберіть користувача</label>
                        <select id="teacher_id" name="teacher_id" class="form-select form-select-md" aria-label=".form-select-sm example" required placeholder="Оберіть групу">
